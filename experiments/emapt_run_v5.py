#!/usr/bin/env python3
"""Cooperative fixed-load ECM v5 EMAPT runner."""
...
from experiments.auto_run_v5 import (
    _apply_v5_policies,
    _helper_profile,
    _preflight_cleanup,
    _write_profile_meta,
...
def main():
    parser = argparse.ArgumentParser(description='Cooperative fixed-load ECM v5 EMAPT runner')
    parser.add_argument('--scenario', choices=['baseline', 'sdnv'], default='sdnv')
    parser.add_argument('--results-tag', default='emapt_v5')
