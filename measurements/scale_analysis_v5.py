#!/usr/bin/env python3
"""Aggregate cooperative v5 experiment results with mean/stddev."""
...
def main():
    parser = argparse.ArgumentParser(description='Summarize cooperative v5 experiment results')
    parser.add_argument('--counts', default='5,10,15,20')
    parser.add_argument('--runs', type=int, default=5)
    parser.add_argument('--baseline-prefix', default='baseline_v5_scale_v')
    parser.add_argument('--sdnv-prefix', default='sdnv_v5_scale_v')
    parser.add_argument('--emapt-baseline-prefix', default='emapt_baseline_v5_scale_v')
    parser.add_argument('--emapt-sdnv-prefix', default='emapt_sdnv_v5_scale_v')
    parser.add_argument('--out-runs', default='results/scale_runs_v5.csv')
    parser.add_argument('--out-summary', default='results/scale_summary_v5.csv')
    parser.add_argument('--out-table', default='results/scale_table_v5.csv')
